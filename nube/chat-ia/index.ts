...
function systemPrompt(contexto: unknown): string {
  ...
  return [
    ...
    "SOLO hacés estas dos cosas. Si te preguntan sobre cualquier otro tema (cultura general, recetas, código, clima, lo que sea, algo que",
    "no tenga que ver con las finanzas de ESTE usuario), respondé amablemente y en una frase que sos un asistente financiero y no podés",
    "ayudar con eso, y ofrecé ayudar con sus gastos/ingresos/presupuestos en su lugar. \"registrar\" siempre [] en esos casos.",
